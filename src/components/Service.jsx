  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" className="bi bi-wallet2" viewBox="0 0 16 16">
        <path d="M12.136.326A1.5 1.5 0 0 1 14 1.78V3h.5A1.5 1.5 0 0 1 16 4.5v9a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 13.5v-9A1.5 1.5 0 0 1 1.5 3H2V1.78A1.5 1.5 0 0 1 3.864.326l8.272-.001zM3 4v2h10V4H3zm0 3v6h10V7H3z"></path>
      </svg>
    ),
  },
  {
    title: 'Web & Email Marketing',
    description: 'This is a wider card with supporting text below as a natural content.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" className="bi bi-mailbox" viewBox="0 0 16 16">
        <path d="M4 4a4 4 0 1 1 8 0v1h-3V4a1 1 0 0 0-2 0v1H4V4z"></path>
        <path d="M3 6h10a1 1 0 0 1 1 1v8H2V7a1 1 0 0 1 1-1z"></path>
        <path d="M2 9v2h4V9H2z"></path>
      </svg>
    ),
  },
];
  ...
  <div id="services" className="section relative pt-20 pb-8 md:pt-16 md:pb-0 bg-white">
    <div className="container xl:max-w-6xl mx-auto px-4">
      <header className="text-center mx-auto mb-12 lg:px-20">
        <h2 className="text-2xl leading-normal mb-2 font-bold text-black my-5">What We Do</h2>
        <svg
          version="1.1"
        ...
        <p className="text-gray-500 leading-relaxed font-light text-xl mx-auto pb-1 ">
