...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto my-7 text-black">

  <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
    <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-black">Pricing</h2>
    <p class="mt-1 text-gray-600 dark:text-black">Whatever your status, our offers evolve according to your needs.</p>
  </div>
  ...
  <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
    ...
    <div class="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-neutral-800">
      <h4 class="font-medium text-lg text-gray-800 dark:text-black">Free</h4>
      <span class="mt-7 font-bold text-5xl text-gray-800 dark:text-black">Free</span>
    ...
    <div class="flex flex-col border-2 border-blue-600 text-center shadow-xl rounded-xl p-8 dark:border-blue-700">
      ...
      <h4 class="font-medium text-lg text-gray-800 dark:text-black">Startup</h4>
      <span class="mt-5 font-bold text-5xl text-gray-800 dark:text-black">
        <sub class="font-bold text-2xl -me-2">$ &emsp;</sub>
        39
      </span>
    ...
    <div class="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-neutral-800">
      <h4 class="font-medium text-lg text-gray-800 dark:text-black">Team</h4>
      <span class="mt-5 font-bold text-5xl text-gray-800 dark:text-black">
        <sub class="font-bold text-2xl -me-2">$ &emsp;</sub>
        89
      </span>
    ...
    <div class="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-neutral-800">
      <h4 class="font-medium text-lg text-gray-800 dark:text-black">Enterprise</h4>
      <span class="mt-5 font-bold text-5xl text-gray-800 dark:text-black">
        <sub class="font-bold text-2xl -me-2">$ &emsp;</sub>
        149
      </span>
